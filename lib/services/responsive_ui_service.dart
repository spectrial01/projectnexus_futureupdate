...
class ResponsiveUIService {
  ...
  static int getGridCrossAxisCount(BuildContext context, {
    ...
    final isVerySmallScreen = screenSize.width < 320 || screenSize.height < 500;
  ...
  /// Get optimal spacing for metric cards based on screen size
  static double getMetricCardSpacing(BuildContext context) {
    final screenSize = MediaQuery.of(context).size;
    final isVerySmallScreen = screenSize.width < 320 || screenSize.height < 500;
    
    if (isVerySmallScreen) {
      return 8.0; // Tighter spacing for small screens
